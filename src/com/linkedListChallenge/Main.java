...
//        Customer customer = new Customer("Time", 100.00);
//        Customer anotherCustomer;
//
//        anotherCustomer = customer;
//        anotherCustomer.setBalance(12.18);
//
//        System.out.println("Customer name is " + customer.getName() + " customer balance is " + customer.getBalance());
//
//        ArrayList<Integer> intList = new ArrayList<>();
//        intList.add(1);
//        intList.add(3);
//        intList.add(4); // in the background this is Integer.valueOf(4); // this is autoboxing
//
...
//
//        for(int i = 0; i < intList.size(); i++) {
//            System.out.println("Second pass " + intList.get(i));
//        }
//
//        LinkedList<String> placesToVisit = new LinkedList<>();
//        addCityInOrder(placesToVisit, "Denver");
//        addCityInOrder(placesToVisit,"Seattle");
//        addCityInOrder(placesToVisit,"New York City");
//        addCityInOrder(placesToVisit,"San Francisco");
//
//        printList(placesToVisit);
//
//        addCityInOrder(placesToVisit, "Denver");
//
//        addCityInOrder(placesToVisit,"Toronto"); // the add function is updating the address the previous index points too
//        printList(placesToVisit);
//
//        visit(placesToVisit);
//
//        placesToVisit.remove(3); // the remove function is updating the address the previous index points too
//        printList(placesToVisit);

        LinkedList<Song> playList = new LinkedList<>();

        Album album1 = new Album("City of Evil", "Avenged Sevenfold");
        if(album1.addNewSongToAlbum("Beast and the Harlot", 5.41)) {
            System.out.println("Song successfully added to album");
        } else {
            System.out.println("Adding the song failed");
        }

        album1.addNewSongToAlbum("Beast and the Harlot", 5.41);
        album1.addNewSongToAlbum("Burn It Down", 5.00);
        album1.addNewSongToAlbum("Blinded in Chains", 6.34);

        Album album2 = new Album("Load", "Metallica");
        album2.addNewSongToAlbum("Aint my Bitch", 5.04);
        album2.addNewSongToAlbum("2 X 4", 5.28);
        album2.addNewSongToAlbum("The House That Jack Built", 6.39);

        Album album3 = Album.createAlbum("Wrath", "Lamb of God");
        //Album album3 = new Album("Wrath", "Lamb of God");
        album3.addNewSongToAlbum("In Your Words", 5.24);
        album3.addNewSongToAlbum("Set To Fail", 3.47);
        album3.addNewSongToAlbum("Contractor", 3.22);
